...
def crossover(parent1, parent2):
    ...
    mutation_rate = 0.3
    while(random.random() < mutation_rate and size > 1):
...
combined = [(parent1, calculatetakentime(parent1)), (parent2, calculatetakentime(parent2))] + children
combined.sort(key=lambda x: x[1])
nextgeneration = combined[:population_size]
